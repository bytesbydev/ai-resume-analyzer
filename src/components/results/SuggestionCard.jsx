  ...
  const suggestions = [
    {
      ...
      priority: "high",
      category: "Content",
      impact: "Makes accomplishments more concrete and impressive to recruiters",
      before: "Improved team productivity",
      after: "Increased team productivity by 35% through implementing automated workflows, reducing processing time from 4 hours to 2.6 hours per task",
    ...
    },
    {
      ...
      after: "Technical Skills: React, TypeScript, Node.js, MongoDB, PostgreSQL, RESTful APIs, Git, CI/CD",
      timeToFix: "5 min",
    },
    {
      id: "3",
      ...
      priority: "high",
      category: "Quality",
      impact: "Professional appearance matters - errors can lead to immediate rejection",
    ...
    },
    {
      ...
      after: "Led cross-functional team of 8 to deliver project 2 weeks ahead of schedule, under budget by 15%",
